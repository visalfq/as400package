...
try
{
  lno = "2";
    ...
    await pjs.define("parm5", { type: "char", length: 2 });
    await pjs.define("parm6", { type: "char", length: 9 });
    await pjs.define("parm7", { type: "char", length: 8 });
    await pjs.define("parm8", { type: "char", length: 11 });
    
    await pjs.define("parm9", { type: "char", length: 11 });
    await pjs.define("parm10", { type: "char", length: 11 });
    await pjs.define("parm11", { type: "char", length: 3 });
    await pjs.define("parm12", { type: "char", length: 3 });
    await pjs.define("parm13", { type: "char", length: 1 });
    await pjs.define("parm14", { type: "char", length: 15 });
    await pjs.define("parm15", { type: "char", length: 1 });
    await pjs.define("parm16", { type: "char", length: 1 });
    await pjs.define("parm17", { type: "packed decimal", length: 9, decimals: 0 });
    await pjs.define("parm18", { type: "packed decimal", length: 3, decimals: 0 });
    await pjs.define("parm19", { type: "packed decimal", length: 4, decimals: 0 });
    await pjs.define("parm20", { type: "char", length: 3 });
    await pjs.define("parm21", { type: "char", length: 1 });
    await pjs.define("parm22", { type: "char", length: 1 });
    await pjs.define("parm23", { type: "char", length: 20 });
...
exports.getstockandpricemultipleitems = getstockandpricemultipleitems;
